...
#summarizing data for foraging efficiency graph (2019)
...
#plotting foraging efficiency graph (2019)
...
p1<- ggplot(data.summary2, aes(x=Hour, y=mean, color=Site, shape=Site)) + 
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + scale_color_manual(values=c('grey4','grey47')) + coord_cartesian(xlim = c(6, 20), ylim = c(0.1, 0.6)) + scale_x_continuous(breaks = round(seq(min(data.summary2$Hour), max(data.summary2$Hour), by = 2),1)) + theme(axis.title.y = element_text(color = "black", size = 22, margin = margin(t = 15, r = 15, b = 15, l = 15))) + theme(axis.title.x = element_text(color = "black", size = 22, margin = margin(t = 15, r = 15, b = 15, l = 15))) + theme(legend.text = element_text(size = 20)) + theme(legend.title = element_text(size = 25)) + theme(axis.text.x=element_text(colour="black", size=20)) + theme(axis.text.y=element_text(colour="black", size=20)) + ggtitle("2019") + theme(plot.title = element_text(face = "bold", hjust = 0.5, size =36))

p1 

#summarizing data for foraging efficiency graph (2020)
...
#plotting foraging efficiency graph (2020)
...
p2<- ggplot(data.summary2, aes(x=Hour, y=mean, color=Site, shape=Site)) + 
  ...
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se), width=0.8,
                position=position_dodge(0.05)) +labs(x="Hour of Day", y = "Foraging Efficiency")+
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + scale_color_manual(values=c('grey4','grey47')) + coord_cartesian(xlim = c(6, 20), ylim = c(0.1,0.6)) + scale_x_continuous(breaks = round(seq(min(data.summary2$Hour), max(data.summary2$Hour), by = 2),1)) + theme(legend.text = element_text(size = 20)) + theme(legend.title = element_text(size = 22)) + theme(axis.text.x=element_text(colour="black")) + theme(axis.title.y = element_text(color = "black", size = 22, margin = margin(t = 15, r = 15, b = 15, l = 15))) + theme(axis.title.x = element_text(color = "black", size = 22, margin = margin(t = 15, r = 15, b = 15, l = 15))) + theme(legend.text = element_text(size = 20)) + theme(legend.title = element_text(size = 25)) + theme(axis.text.x=element_text(colour="black", size=20)) + theme(axis.text.y=element_text(colour="black", size=20)) + ggtitle("2020") + theme(plot.title = element_text(face = "bold", hjust = 0.5, size =36))

p2 

#summarizing wiggle data for graph (2019)

Dive_summary = both2019[, .("Meanbird" = mean(NoWiggles, na.rm = TRUE), "sd" = sd(NoWiggles, na.rm = TRUE)), by = c("birdID", "Site", "Hour")]
...
#plotting wiggle graph (2019)

p3<- ggplot(data.summary2, aes(x=Hour, y=mean, color=Site, shape=Site)) + 
  geom_line() +
  geom_point(size = 5.5)+
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se), width=0.8,
                position=position_dodge(0.05)) +labs(x="Hour of Day", y = "Number of Wiggles")+
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + scale_color_manual(values=c('grey4','grey47')) + coord_cartesian(xlim = c(6, 20), ylim = c(0, 15)) + scale_x_continuous(breaks = round(seq(min(data.summary2$Hour), max(data.summary2$Hour), by = 2),1)) + theme(axis.title.y = element_text(color = "black", size = 22, margin = margin(t = 15, r = 15, b = 15, l = 15))) + theme(axis.title.x = element_text(color = "black", size = 22, margin = margin(t = 15, r = 15, b = 15, l = 15))) + theme(legend.text = element_text(size = 20)) + theme(legend.title = element_text(size = 25)) + theme(axis.text.x=element_text(colour="black", size=20)) + theme(axis.text.y=element_text(colour="black", size=20))

p3

#summarizing wiggle data for graph (2020)

Dive_summary = both2020[, .("Meanbird" = mean(NoWiggles, na.rm = TRUE), "sd" = sd(NoWiggles, na.rm = TRUE)), by = c("birdID", "Site", "Hour")]
...
#plotting wiggle graph (2020)

p4<- ggplot(data.summary2, aes(x=Hour, y=mean, color=Site, shape=Site)) + 
  geom_line() +
  geom_point(size = 5.5)+
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se), width=0.8,
                position=position_dodge(0.05)) +labs(x="Hour of Day", y = "Number of Wiggles")+
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + scale_color_manual(values=c('grey4','grey47')) + coord_cartesian(xlim = c(6, 20), ylim = c(0,15)) + scale_x_continuous(breaks = round(seq(min(data.summary2$Hour), max(data.summary2$Hour), by = 2),1)) + theme(legend.text = element_text(size = 20)) + theme(legend.title = element_text(size = 22)) + theme(axis.text.x=element_text(colour="black")) + theme(axis.title.y = element_text(color = "black", size = 22, margin = margin(t = 15, r = 15, b = 15, l = 15))) + theme(axis.title.x = element_text(color = "black", size = 22, margin = margin(t = 15, r = 15, b = 15, l = 15))) + theme(legend.text = element_text(size = 20)) + theme(legend.title = element_text(size = 25)) + theme(axis.text.x=element_text(colour="black", size=20)) + theme(axis.text.y=element_text(colour="black", size=20))
